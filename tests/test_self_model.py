...
def test_build_self_model_index_is_aggregation_only_for_seed_records():
    ...
    assert index["active_capabilities"] == ["CAP-0001", "CAP-0002", "CAP-0003", "CAP-0004", "CAP-0005", "CAP-0006", "CAP-0007", "CAP-0008"]
...
def test_build_self_model_script_writes_index(tmp_path):
    ...
    assert data["active_capabilities"] == ["CAP-0001", "CAP-0002", "CAP-0003", "CAP-0004", "CAP-0005", "CAP-0006", "CAP-0007", "CAP-0008"]
...
def test_build_self_model_index_includes_warrant_records():
    ...
    assert index["warrant_counts"]["supported"] == 33
...
def test_build_self_model_index_records_verification_20260707_0003_for_threshold_completion():
    ...
    assert len(index["verifications"]) == 18
    assert any(
