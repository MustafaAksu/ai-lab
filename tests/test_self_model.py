...
def test_build_self_model_index_includes_warrant_records():
    ...
    assert index["warrant_counts"]["supported"] == 10
    assert index["admitted_plans"] == ["PLAN-20260705-0001", "PLAN-20260706-0001", "PLAN-20260706-0002", "PLAN-20260706-0003", "PLAN-20260706-0004"]
    assert {
        warrant["warrant_id"]
        for warrant in index["warrants"]
    } == {"WARR-20260705-0001", "WARR-20260705-0002", "WARR-20260706-0001", "WARR-20260706-0002", "WARR-20260706-0003", "WARR-20260706-0004", "WARR-20260706-0005", "WARR-20260706-0006", "WARR-20260706-0007", "WARR-20260706-0008"}
...
def test_validate_plan_record_accepts_plan_20260707_0001_proposed():
...
def test_build_self_model_index_records_plan_20260707_0001_proposed():
    from ai_lab.documentation.self_model import build_self_model_index
    ...
    assert index["plan_counts"].get("admitted", 0) == 0
    assert index["open_plans"] == ["PLAN-20260707-0001"]
    assert "PLAN-20260707-0001" not in index["admitted_plans"]
    assert any(
