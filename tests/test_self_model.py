...
def test_build_self_model_index_includes_plan_records():
    ...
    assert index["plan_counts"]["completed"] == 4
    assert index["plan_counts"].get("admitted", 0) == 1
    assert index.get("plan_counts", {}).get("proposed", 0) == 0
    assert index["open_plans"] == ["PLAN-20260706-0004"]
    assert {
        plan["plan_id"]
        for plan in index["plans"]
    } == {"PLAN-20260705-0001", "PLAN-20260706-0001", "PLAN-20260706-0002", "PLAN-20260706-0003", "PLAN-20260706-0004"}
...
def test_build_self_model_index_includes_warrant_records():
    ...
    assert index["warrant_counts"]["supported"] == 9
    ...
    } == {"WARR-20260705-0001", "WARR-20260705-0002", "WARR-20260706-0001", "WARR-20260706-0002", "WARR-20260706-0003", "WARR-20260706-0004", "WARR-20260706-0005", "WARR-20260706-0006", "WARR-20260706-0007"}
...
def test_build_self_model_index_records_plan_20260706_0004_as_admitted():
    from ai_lab.documentation.self_model import build_self_model_index
