...
def test_build_self_model_index_includes_warrant_records():
    ...
    assert index["warrant_counts"]["supported"] == 16
...
def test_validate_plan_record_accepts_plan_20260707_0004_proposed():
    import json
    from pathlib import Path
    from ai_lab.documentation.self_model import validate_plan_record
...
def test_build_self_model_index_records_plan_20260707_0004_as_open_proposed():
    from pathlib import Path
    from ai_lab.documentation.self_model import build_self_model_index
