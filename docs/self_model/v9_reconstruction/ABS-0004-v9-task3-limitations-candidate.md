...
- sentence discipline: every normative statement is tagged `[DEF]`
  ...
  candidate implementation boundary subject to future governance, `[OPEN]`
  open question, or `[LIMITATION]` descriptive boundary on what the ontology,
  its records, or current enforcement establish. A limitation imposes no new
