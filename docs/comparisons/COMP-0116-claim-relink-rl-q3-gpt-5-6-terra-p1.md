# COMP-0116: Provider Comparison — Claim relink RL-Q3-gpt-5-6-terra-p1

## Metadata

- comparison_id: `COMP-0116`
- title: `Claim relink RL-Q3-gpt-5-6-terra-p1`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-ee2b037200256b69.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0116", "target_id": "INV-ee2b037200256b69"}, {"authoritative": false, "evidence": "docs/invocations/INV-5ec341ba3e742ccd.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0116", "target_id": "INV-5ec341ba3e742ccd"}]`
- created_at: `2026-07-30T13:35:09.160324+00:00`
- command: `scripts/compare_providers.py --title Claim relink RL-Q3-gpt-5-6-terra-p1 You are linking claims to the block of source text each claim is about. The source document has been amended since these claims were written, and the blocks below are the amended text. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The self-issued marking requires disclosure and disqualifies the authorization from counting as independent where independence is required.
   ...
   extractor called it about: self_issued marking rule

2. claim: A false or opportunistic standing-authority claim can yield effective authorization in the repository’s authorization records while leaving the real-world authority claim unverified.
...
3. claim: Section 3 does not impose an independence requirement on every invocation authorization.
   quote: "Section 3 does not impose an independence requirement on every invocation authorization."
   extractor called it about: Section 3 independence requirement scope

4. claim: The stated constraint makes visibility rather than prevention its effect.
...
5. claim: The system does not validate whether X is actually entitled to that standing authority.
   quote: "The system does not validate whether X is actually entitled to that standing authority."
   extractor called it about: standing-authority claim verification

6. claim: The path works where no applicable authorization condition requires independent authorization.
   quote: "The path therefore works where no applicable authorization condition requires independent authorization."
   extractor called it about: conditions under which path succeeds

7. claim: A standing-authority claim is recorded rather than verified.
   quote: "The claim is recorded rather than verified"
   extractor called it about: standing-authority claim

8. claim: The path works where no applicable authorization condition requires independent authorization.
   quote: "The path therefore works where no applicable authorization condition requires independent authorization."
   extractor called it about: self-issued authorization path

9. claim: Section 3 does not impose an independence requirement on every invocation authorization.
   quote: "Section 3 does not impose an independence requirement on every invocation authorization."
   extractor called it about: Section 3 invocation authorization requirements

10. claim: The system does not validate whether X is actually entitled to that standing authority.
   quote: "The system does not validate whether X is actually entitled to that standing authority."
   extractor called it about: standing-authority entitlement validation

11. claim: The breadth of a standing-authority scope may be arbitrarily wide.
   quote: "scope breadth may be arbitrarily wide."
   extractor called it about: standing-authority claim scope

12. claim: A false or opportunistic standing-authority claim can yield effective authorization in the repository's authorization records while leaving the real-world authority claim unverified.
   quote: "a false or opportunistic standing-authority claim can yield effective authorization *in the repository’s authorization records* while leaving the real-world authority claim unverified"
   extractor called it about: standing-authority claim / repository authorization
...
```
{"links":[{"claim":1,"blocks":["ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke---","ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona---"],"reason_if_empty":""},{"claim":2,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco---","ABS-0004:v7:S3#def:authorization-chain-termination-a---","ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi---"],"reason_if_empty":""},{"claim":3,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona---","ABS-0004:v7:S4.13#def:invocationauthorization-decision-k---"],"reason_if_empty":""},{"claim":4,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco---"],"reason_if_empty":""},{"claim":5,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco---","ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi---"],"reason_if_empty":""},{"claim":6,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona---"],"reason_if_empty":""},{"claim":7,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco---"],"reason_if_empty":""},{"claim":8,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona---"],"reason_if_empty":""},{"claim":9,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona---","ABS-0004:v7:S4.13#def:invocationauthorization-decision-k---"],"reason_if_empty":""},{"claim":10,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco---","ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi---"],"reason_if_empty":""},{"claim":11,"blocks":["ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-and-bread---"],"reason_if_empty":""},{"claim":12,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco---","ABS-0004:v7:S3#def:authorization-chain-termination-a---","ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi---"],"reason_if_empty":""}]}
```
...
```
{"links":[
{"claim":1,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona","ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"],"reason_if_empty":""},
{"claim":2,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"],"reason_if_empty":""},
{"claim":3,"blocks":[],"reason_if_empty":"No block asserts that Section 3 does not impose an independence requirement on every invocation authorization; the amended text discusses independence requirements being deferred to AuthorizationPolicy, not a claim about Section 3's scope of imposition."},
{"claim":4,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"],"reason_if_empty":""},
{"claim":5,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"],"reason_if_empty":""},
{"claim":6,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona"],"reason_if_empty":""},
{"claim":7,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"],"reason_if_empty":""},
{"claim":8,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona"],"reason_if_empty":""},
{"claim":9,"blocks":[],"reason_if_empty":"No block asserts that Section 3 does not impose an independence requirement on every invocation authorization; the amended text discusses independence requirements being deferred to AuthorizationPolicy, not a claim about Section 3's scope of imposition."},
{"claim":10,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"],"reason_if_empty":""},
{"claim":11,"blocks":["ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-and-bread"],"reason_if_empty":""},
{"claim":12,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"],"reason_if_empty":""}
]}
```
