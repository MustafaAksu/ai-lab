# COMP-0089: Provider Comparison — Claim linking LK-EX-Q3-gpt-5-6-terra-by-claude-sonnet-5

## Metadata

- comparison_id: `COMP-0089`
- title: `Claim linking LK-EX-Q3-gpt-5-6-terra-by-claude-sonnet-5`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-bffca5060029dd02.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0089", "target_id": "INV-bffca5060029dd02"}, {"authoritative": false, "evidence": "docs/invocations/INV-4d93d1b233c04434.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0089", "target_id": "INV-4d93d1b233c04434"}]`
- created_at: `2026-07-29T06:22:54.078780+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q3-gpt-5-6-terra-by-claude-sonnet-5 You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: A path exists within the record system; it does not establish real-world root authority.
   quote: "A path exists within the record system; it does not establish real-world root authority."
   extractor called it about: overall construction / Section 3 path

2. claim: The authorization terminates at X's recorded standing authority and is therefore self-standing within the declared scope, under the ontology's chain rule.
   ...
   extractor called it about: chain rule / InvocationAuthorization termination

3. claim: The system does not validate whether X is actually entitled to that standing authority.
...
4. claim: A false or opportunistic standing-authority claim can yield effective authorization in the repository's authorization records while leaving the real-world authority claim unverified.
...
5. claim: The self-issued marking does not block this construction.
   quote: "The self-issued marking does not block this construction."
   extractor called it about: self_issued marking effect on construction

6. claim: The self-issued marking requires disclosure and disqualifies the authorization from counting as independent where independence is required.
...
7. claim: Section 3 does not impose an independence requirement on every invocation authorization.
...
9. claim: If an applicable condition does require independent authorization, the self-issued record cannot satisfy that independent-authorization condition.
   quote: "If such a condition does apply, the self-issued record cannot satisfy that independent-authorization condition."
   extractor called it about: conditions under which path fails

10. claim: The construction can misrepresent who authorized what in the practically important sense that the record attributes the authorization to X's standing authority even when X lacks that authority in the world.
   quote: "This can also misrepresent who authorized what in the practically important sense that the record attributes the authorization to X’s standing authority even when X lacks that authority in the world."
   extractor called it about: misrepresentation of authorization attribution

11. claim: The record remains legible and attributable, but the stated constraint expressly makes visibility rather than prevention its effect.
   quote: "The record remains legible and attributable, but the stated constraint expressly makes visibility rather than prevention its effect."
   extractor called it about: visibility vs prevention effect of Section 3 constraint

12. claim: The applicable policy and any invocation-specific conditions or independence requirements are not provided, and would be needed to determine whether the particular planned invocation requires independent authorization and therefore defeats the self-issued path.
   quote: "the applicable policy and any invocation-specific conditions or independence requirements are not provided"
   extractor called it about: policy and invocation-specific independence conditions

13. claim: The record identifies the decision as an invocation authorization and supplies the authorized executor, role, consequence class, policy, qualifications, independence requirements, and conditions.
   quote: "The record identifies the decision as an invocation authorization and supplies the authorized executor, role, consequence class, policy, qualifications, independence requirements, and conditions."
   extractor called it about: InvocationAuthorization record fields in constructed path
...
```
{"links":[{"claim":1,"block":"ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi"},{"claim":2,"block":"ABS-0004:v7:S3#def:authorization-chain-termination-a"},{"claim":3,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":4,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":5,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":6,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":7,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":8,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":9,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":10,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":11,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":12,"block":null,"reason_if_null":"It concerns missing applicable policy and invocation-specific conditions for a particular planned invocation, which are not provided in the candidate blocks."},{"claim":13,"block":"ABS-0004:v7:S4.13#def:invocationauthorization-decision-k"}]}
```
...
```
{"links":[
{"claim":1,"block":"ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi","reason_if_null":null},
{"claim":2,"block":"ABS-0004:v7:S3#def:authorization-chain-termination-a","reason_if_null":null},
...
{"claim":7,"block":null,"reason_if_null":"Claim is a broad interpretive generalization about Section 3's scope not stated verbatim in any single block; it synthesizes across multiple provisions rather than describing one passage."},
{"claim":8,"block":null,"reason_if_null":"Claim describes a conditional outcome of the overall construction not directly asserted in any single candidate block; it is an inference from combining several provisions."},
{"claim":9,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke","reason_if_null":null},
{"claim":10,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco","reason_if_null":null},
{"claim":11,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco","reason_if_null":null},
{"claim":12,"block":null,"reason_if_null":"Claim concerns missing details of a specific hypothetical constructed invocation not present in any candidate block, rather than the definitional field list itself."},
{"claim":13,"block":"ABS-0004:v7:S4.13#def:invocationauthorization-decision-k","reason_if_null":null}
]}
```
