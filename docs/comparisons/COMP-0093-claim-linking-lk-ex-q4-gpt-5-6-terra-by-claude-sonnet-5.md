# COMP-0093: Provider Comparison — Claim linking LK-EX-Q4-gpt-5-6-terra-by-claude-sonnet-5

## Metadata

- comparison_id: `COMP-0093`
- title: `Claim linking LK-EX-Q4-gpt-5-6-terra-by-claude-sonnet-5`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-89c04530563f4594.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0093", "target_id": "INV-89c04530563f4594"}, {"authoritative": false, "evidence": "docs/invocations/INV-d8af0635ad2911c6.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0093", "target_id": "INV-d8af0635ad2911c6"}]`
- created_at: `2026-07-29T06:26:58.822158+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q4-gpt-5-6-terra-by-claude-sonnet-5 You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The ten enumerated refusal reasons are not complete for the plan's stated meaning of a "valid authorization."
   quote: "The ten reasons are not complete for the plan’s stated meaning of a “valid authorization.”"
   extractor called it about: completeness of ten refusal reasons

2. claim: The plan neither incorporates nor excludes nor defers the Section 4.7 disclosure constraints, and this omission is material.
   quote: "But it neither incorporates nor excludes or defers the Section 4.7 disclosure constraints. That omission is material."
   extractor called it about: Section 4.7 disclosure constraints disposition

3. claim: The plan should state that the Section 4.7 constraints are checked by authorize() as validity conditions, from stored declarations and records, with refusal when the applicable constraint is violated, as an authorization-result refusal rather than a refusal to execute.
   quote: "The plan should state that the Section 4.7 constraints are **checked by `authorize()` as validity conditions**, from stored declarations and records, with refusal when the applicable constraint is violated."
   extractor called it about: disposition the plan should state for Section 4.7 constraints

4. claim: There should be a refusal case for undisclosed material subordinate execution where a material subordinate execution capable of influencing output or external effect is not represented as an Invocation linked to its parent by spawned.
   quote: "refuse where a material subordinate execution capable of influencing the output or external effect is not represented as an Invocation linked to its parent by `spawned`"
   extractor called it about: missing refusal case: undisclosed material subordinate execution

5. claim: The existing 'subordinate execution outside declared classes' reason covers only a declared subordinate exceeding declared executor kinds, roles, or consequence ceiling, and does not cover an undisclosed subordinate at all.
   quote: "It does not cover an undisclosed subordinate at all."
   extractor called it about: existing subordinate-execution refusal reason scope

6. claim: There should be a refusal case for undeclared execution-path-changing tool configuration, for a ToolIdentity whose output enters governed evidence, where such configuration is not declared and content-addressed in its EffectiveInputManifest.
   quote: "refuse where a configuration file, environment variable, or local dependency capable of altering execution path is not declared and content-addressed in its EffectiveInputManifest"
   extractor called it about: missing refusal case: undeclared execution-path-changing tool configuration

7. claim: This tool-configuration refusal case is distinct from qualification scope and from ordinary unmet authorization conditions.
   quote: "This is distinct from qualification scope and from ordinary unmet authorization conditions."
   extractor called it about: undeclared execution-path-changing tool configuration case distinctness

8. claim: There should be a refusal case for undeclared material external interaction, for executors producing governed evidence or holding above-read_only action authority, including network calls, external writes, and privileged ambient consumers such as hardcoded targets.
   quote: "refuse where material external interactions are undeclared. This includes network calls, external writes, and privileged ambient consumers, including hardcoded targets."
   extractor called it about: missing refusal case: undeclared material external interaction

9. claim: The plan should say that the relevant stored enforcement evidence for undeclared material external interaction is the OutboundInteractionLog, with authorize() remaining pure by evaluating stored records rather than performing I/O.
   quote: "The plan should say that the relevant stored enforcement evidence is the `OutboundInteractionLog`; `authorize()` remains pure by evaluating stored records rather than performing I/O."
   extractor called it about: OutboundInteractionLog as enforcement evidence

10. claim: If the plan instead intends to exclude these checks from validity or defer them, it must say so expressly and must not describe its result as a valid authorization under the adopted v7 meaning.
   quote: "it must say so expressly and must not describe its result as a valid authorization under the adopted v7 meaning"
   extractor called it about: alternative disposition (exclusion/deferral) requirement

11. claim: Deferral would leave the invocation experimental, or otherwise require a clearly narrower, Slice-C-only term rather than silently treating disclosure-noncompliant work as governed.
   quote: "Deferral would leave the invocation experimental, or otherwise require a clearly narrower, Slice-C-only term rather than silently treating disclosure-noncompliant work as governed."
   extractor called it about: consequence of deferring Section 4.7 checks

12. claim: A further missing refusal case is 'no matching authorization covers the invocation,' since no listed refusal reason states the absence of a matching authorization record, and 'authorized executor does not match' presupposes an authorization already exists.
   quote: "no listed refusal reason is “no authorization covers this invocation.” “Authorized executor does not match” presupposes an authorization; it does not identify the absence of one."
   extractor called it about: missing refusal case: no matching authorization covers invocation

13. claim: A further missing refusal case is an unmet independence requirement: a self-issued authorization where independent authorization is required must refuse even if the one-hop self-adjudication-conflict test does not trigger, and the plan cannot silently pass an authorization requiring independence that cannot be established since independence assessment is expressly deferred.
   quote: "A self-issued authorization where independent authorization is required must refuse even if that particular one-hop artifact test does not trigger."
   extractor called it about: missing refusal case: unmet independence requirement

14. claim: The reason 'authorization conditions unmet, malformed, or absent' is overly broad, combining a substantive failed condition, malformed authorization data, and missing conditions, which differ in diagnosis and remediation, and it must not serve as an unstated catch-all for the three Section 4.7 disclosure violations.
   quote: "combines a substantive failed condition, malformed authorization data, and missing conditions. These differ in both diagnosis and remediation."
   extractor called it about: refusal reason 'conditions unmet, malformed, or absent'

15. claim: The reason 'the authorization or a record it relies on is inactive or superseded' is overly broad, combining status failure of the authorization itself with status failure of a relied-on record, and a superseded qualification, an inactive principal record, and an inactive authorization are materially different failures.
   quote: "A superseded qualification, an inactive principal record, and an inactive authorization are materially different failures."
   extractor called it about: refusal reason 'inactive or superseded'

16. claim: The reason 'subordinate execution outside the classes its parent authorization declares' aggregates exceeding declared executor kind, role, and consequence ceiling, while omitting the separate case of undisclosed subordinate execution.
   quote: "aggregates exceeding declared executor kind, role, and consequence ceiling, while omitting the separate case of undisclosed subordinate execution"
   extractor called it about: refusal reason 'subordinate execution outside declared classes'

17. claim: The supplied evidence is sufficient to identify these omissions.
   quote: "The supplied evidence is sufficient to identify these omissions."
   extractor called it about: sufficiency of evidence for identifying omissions

18. claim: A complete assessment of every possible validity refusal is not possible from the supplied evidence alone; Section 4.9 would be needed for full RoleDefinition constraint fields, Section 4.13 for all inherited DecisionRecord requirements, and the referenced Section 11 definition of OutboundInteractionLog for its exact required fields and validation conditions.
   quote: "Section 4.9 would be needed for the full RoleDefinition constraint fields, Section 4.13 for all inherited DecisionRecord requirements, and the referenced Section 11 definition of `OutboundInteractionLog` for its exact required fields and validation conditions."
   extractor called it about: materials needed for complete refusal-reason assessment
...
```
{"links":[{"claim":1,"block":"PLAN-20260723-0002#scope[4]"},{"claim":2,"block":"PLAN-20260723-0002#scope[4]"},{"claim":3,"block":"PLAN-20260723-0002#scope[4]"},{"claim":4,"block":"PLAN-20260723-0002#scope[4]"},{"claim":5,"block":"PLAN-20260723-0002#scope[4]"},{"claim":6,"block":"PLAN-20260723-0002#scope[4]"},{"claim":7,"block":"PLAN-20260723-0002#scope[4]"},{"claim":8,"block":"PLAN-20260723-0002#scope[4]"},{"claim":9,"block":"PLAN-20260723-0002#scope[4]"},{"claim":10,"block":"PLAN-20260723-0002#scope[7]"},{"claim":11,"block":"PLAN-20260723-0002#scope[7]"},{"claim":12,"block":"PLAN-20260723-0002#scope[4]"},{"claim":13,"block":"PLAN-20260723-0002#non_goals[2]"},{"claim":14,"block":"PLAN-20260723-0002#scope[4]"},{"claim":15,"block":"PLAN-20260723-0002#scope[4]"},{"claim":16,"block":"PLAN-20260723-0002#scope[4]"},{"claim":17,"block":null,"reason_if_null":"The claim concerns the sufficiency of the supplied evidence set as a whole, not a specific candidate block."},{"claim":18,"block":null,"reason_if_null":"The claim concerns missing source materials from Sections 4.9, 4.13, and 11 needed for a complete assessment; those full sections are not candidate blocks."}]}
```
...
```
{"links":[
{"claim":1,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":2,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":3,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":4,"block":"ABS-0004:v7:S4.6-4.7#adopted_constraint:composite-executor-disclosure-an-i","reason_if_null":null},
{"claim":5,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":6,"block":"ABS-0004:v7:S4.6-4.7#adopted_constraint:tool-configuration-disclosure-for","reason_if_null":null},
{"claim":7,"block":"ABS-0004:v7:S4.6-4.7#adopted_constraint:tool-configuration-disclosure-for","reason_if_null":null},
{"claim":8,"block":"ABS-0004:v7:S4.6-4.7#adopted_constraint:external-interaction-disclosure-an","reason_if_null":null},
{"claim":9,"block":"ABS-0004:v7:S4.6-4.7#adopted_constraint:external-interaction-disclosure-an","reason_if_null":null},
{"claim":10,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":11,"block":"PLAN-20260723-0002#scope[7]","reason_if_null":null},
{"claim":12,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":13,"block":"PLAN-20260723-0002#scope[5]","reason_if_null":null},
{"claim":14,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":15,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":16,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":17,"block":null,"reason_if_null":"Meta-statement about the sufficiency of the reasoning's own evidence base, not about a specific source block"},
{"claim":18,"block":null,"reason_if_null":"Meta-statement about what additional sections would be needed for a complete assessment, not itself about one specific candidate block"}
]}
```
