# COMP-0104: Provider Comparison — Claim linking LK-EX-Q7-claude-sonnet-5-by-gpt-5-6-terra

## Metadata

- comparison_id: `COMP-0104`
- title: `Claim linking LK-EX-Q7-claude-sonnet-5-by-gpt-5-6-terra`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-c8ab29668dfa6dc3.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0104", "target_id": "INV-c8ab29668dfa6dc3"}, {"authoritative": false, "evidence": "docs/invocations/INV-a51eb6da67b9c449.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0104", "target_id": "INV-a51eb6da67b9c449"}]`
- created_at: `2026-07-29T06:38:16.289322+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q7-claude-sonnet-5-by-gpt-5-6-terra You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: Criterion 1's governed/experimental classification is checkable.
   quote: "Checkable."
   extractor called it about: success criterion 1 governed/experimental classification

2. claim: Criterion 2's ten refusal reasons and authorization-match condition are checkable.
   quote: "Checkable."
   extractor called it about: success criterion 2 refusal reasons and authorization records

3. claim: Criterion 3's chain-termination and authority-scope-violation refusals are checkable.
   quote: "Checkable."
   extractor called it about: success criterion 3 refusal reasons

4. claim: Criterion 4's identity-collision logic is mechanically testable against any fixture InvocationRecord.
   quote: "are testable against any fixture InvocationRecord"
   extractor called it about: success criterion 4 one-hop self-adjudication identity-collision logic

5. claim: Criterion 4's requirement for a real captured InvocationRecord is not mechanically checkable.
   quote: "This sub-clause is not mechanically checkable"
   extractor called it about: success criterion 4 real captured InvocationRecord sub-clause

6. claim: Criterion 5 is checkable only as a formula-consistency test, not as a classification-correctness test.
   quote: "The criterion is checkable as a formula-consistency test, not as a classification-correctness test"
   extractor called it about: success criterion 5 consequence classification

7. claim: The fixtures cannot check whether classification of any real invocation is correct because the mapping from invocation facts to modifier levels does not yet exist as governance text.
   quote: "they cannot check that the classification of any real invocation is correct"
   extractor called it about: Section 8 detailed classification function and success criterion 5

8. claim: Criterion 6's qualification execution-scope rejection is checkable.
   quote: "Checkable."
   extractor called it about: success criterion 6 qualification execution-scope rejection

9. claim: Criterion 7's self-issued authorization behavior is checkable under the plan's exact-identifier-equality rule.
   quote: "Checkable, given the plan's own stated rule"
   extractor called it about: success criterion 7 self-issued authorization

10. claim: Criterion 8's byte-identical Slice A/B regression output is checkable.
   quote: "Checkable."
   extractor called it about: success criterion 8 Slice A/B regression

11. claim: Criterion 9's requirement that the full suite pass offline with no network access is checkable.
   quote: "The full suite passes offline with no network access" is checkable"
   extractor called it about: success criterion 9 offline full-suite requirement

12. claim: Criterion 9's coverage requirement is not fully checkable as written.
   quote: "Not fully checkable as written."
   extractor called it about: success criterion 9 public-entrypoint and enumerated-outcome coverage

13. claim: Criterion 10's audit requirement is not mechanically checkable because no procedure, command, tool, or semantics for verified_current is provided.
   quote: "no procedure, command, tool, or semantics for `verified_current` appears anywhere in the evidence set"
   extractor called it about: success criterion 10 repository audit verified_current

14. claim: Criterion 10's cross-environment reproduction requirement is not mechanically checkable because environments, build inputs, and normalization rules are unspecified.
   quote: "no environments are named, no build inputs are specified, and no normalization rules"
   extractor called it about: success criterion 10 cross-environment reproduction

15. claim: The constraint requiring implementation to remain within a future admission warrant's scope has no corresponding success-criterion check.
   quote: "No success criterion tests scope containment against a warrant"
   extractor called it about: top-level constraint on future admission-warrant scope

16. claim: The constraint requiring field names and semantics to follow ABS-0004 v7 exactly has no corresponding criterion check.
   quote: "No criterion checks field-name/semantic conformance to the ontology text."
   extractor called it about: top-level ABS-0004 v7 field-name and semantic conformance constraint

17. claim: The constraint requiring GraphRelation shape and registered Slice A, B, and C predicates has no corresponding criterion check.
   quote: "No criterion checks predicate-registry conformance or relation shape"
   extractor called it about: top-level GraphRelation and predicate-registry constraint

18. claim: The authorize() purity constraint's no-I/O, no-clock, and caller-supplied-timestamp requirements have no corresponding fixture or check among the ten criteria.
   quote: ""No I/O," "no clock," and "timestamp supplied by caller" have no corresponding fixture or check"
   extractor called it about: top-level authorize() purity constraint

19. claim: ABS-0004 v7 Sections 4.9 and 4.13 were not in the evidence and were needed to assess criterion 3's own-reason requirement and field reconciliation.
   quote: "referenced in `scope` but not in evidence; needed to assess whether criterion 3's "own reason""
   extractor called it about: ABS-0004 v7 Sections 4.9 and 4.13

20. claim: An audit-tool or CI/reproducibility specification was not in the evidence and was needed to assess criterion 10 beyond noting its absence.
   quote: "not in evidence — needed to assess criterion 10 at all, beyond noting its absence."
   extractor called it about: audit-tool or CI/reproducibility specification for success criterion 10
...
```
{"links":[{"claim":1,"block":"PLAN-20260723-0002#success_criteria[0]"},{"claim":2,"block":"PLAN-20260723-0002#success_criteria[1]"},{"claim":3,"block":"PLAN-20260723-0002#success_criteria[2]"},{"claim":4,"block":"PLAN-20260723-0002#success_criteria[3]"},{"claim":5,"block":"PLAN-20260723-0002#success_criteria[3]"},{"claim":6,"block":"PLAN-20260723-0002#success_criteria[4]"},{"claim":7,"block":"ABS-0004:v7:S8#def:ordinal-classes-low-medium-high-no"},{"claim":8,"block":"PLAN-20260723-0002#success_criteria[5]"},{"claim":9,"block":"PLAN-20260723-0002#success_criteria[6]"},{"claim":10,"block":"PLAN-20260723-0002#success_criteria[7]"},{"claim":11,"block":"PLAN-20260723-0002#success_criteria[8]"},{"claim":12,"block":"PLAN-20260723-0002#success_criteria[8]"},{"claim":13,"block":"PLAN-20260723-0002#success_criteria[9]"},{"claim":14,"block":"PLAN-20260723-0002#success_criteria[9]"},{"claim":15,"block":"PLAN-20260723-0002#constraints[0]"},{"claim":16,"block":"PLAN-20260723-0002#constraints[1]"},{"claim":17,"block":"PLAN-20260723-0002#constraints[2]"},{"claim":18,"block":"PLAN-20260723-0002#constraints[3]"},{"claim":19,"block":null,"reason_if_null":"The claim concerns absent ABS-0004 v7 Sections 4.9 and 4.13, which are not candidate blocks."},{"claim":20,"block":null,"reason_if_null":"The claim concerns an absent audit-tool or CI/reproducibility specification, not a listed source block."}]}
```
...
```
{"links":[
{"claim":1,"block":"PLAN-20260723-0002#success_criteria[0]","reason_if_null":null},
{"claim":2,"block":"PLAN-20260723-0002#success_criteria[1]","reason_if_null":null},
{"claim":3,"block":"PLAN-20260723-0002#success_criteria[2]","reason_if_null":null},
{"claim":4,"block":"PLAN-20260723-0002#success_criteria[3]","reason_if_null":null},
{"claim":5,"block":"PLAN-20260723-0002#success_criteria[3]","reason_if_null":null},
{"claim":6,"block":"PLAN-20260723-0002#success_criteria[4]","reason_if_null":null},
{"claim":7,"block":"ABS-0004:v7:S8#def:ordinal-classes-low-medium-high-no","reason_if_null":null},
{"claim":8,"block":"PLAN-20260723-0002#success_criteria[5]","reason_if_null":null},
{"claim":9,"block":"PLAN-20260723-0002#success_criteria[6]","reason_if_null":null},
{"claim":10,"block":"PLAN-20260723-0002#success_criteria[7]","reason_if_null":null},
{"claim":11,"block":"PLAN-20260723-0002#success_criteria[8]","reason_if_null":null},
{"claim":12,"block":"PLAN-20260723-0002#success_criteria[8]","reason_if_null":null},
{"claim":13,"block":"PLAN-20260723-0002#success_criteria[9]","reason_if_null":null},
{"claim":14,"block":"PLAN-20260723-0002#success_criteria[9]","reason_if_null":null},
{"claim":15,"block":"PLAN-20260723-0002#constraints[0]","reason_if_null":null},
{"claim":16,"block":"PLAN-20260723-0002#constraints[1]","reason_if_null":null},
{"claim":17,"block":"PLAN-20260723-0002#constraints[2]","reason_if_null":null},
{"claim":18,"block":"PLAN-20260723-0002#constraints[3]","reason_if_null":null},
{"claim":19,"block":null,"reason_if_null":"Refers to ABS-0004 v7 Sections 4.9 and 4.13 as missing evidence items evaluated by an external reviewer; the sections themselves are not present as a candidate block and the claim is about their absence from the evidence set, not about a specific plan or ABS text block provided."},
{"claim":20,"block":null,"reason_if_null":"Refers to an audit-tool/CI-reproducibility specification that is absent from the evidence set; this missing external document is not among the candidate blocks."}
]}
```
