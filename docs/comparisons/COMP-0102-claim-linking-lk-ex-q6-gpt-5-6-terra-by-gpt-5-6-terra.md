# COMP-0102: Provider Comparison — Claim linking LK-EX-Q6-gpt-5-6-terra-by-gpt-5-6-terra

## Metadata

- comparison_id: `COMP-0102`
- title: `Claim linking LK-EX-Q6-gpt-5-6-terra-by-gpt-5-6-terra`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-d025685eaf484ec7.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0102", "target_id": "INV-d025685eaf484ec7"}, {"authoritative": false, "evidence": "docs/invocations/INV-479e457f028b7ced.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0102", "target_id": "INV-479e457f028b7ced"}]`
- created_at: `2026-07-29T06:37:32.709506+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q6-gpt-5-6-terra-by-gpt-5-6-terra You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: Slice C as described would not, merely by adding role and authorization records, give C6’s matrix row current enforcement evidence.
   ...
   extractor called it about: C6 matrix row current enforcement evidence

2. claim: Role records and authorization records are not by themselves evidence that C6 was checked.
   quote: "They are **not by themselves evidence that C6 was checked**"
   extractor called it about: role records and authorization records as C6 enforcement evidence

3. claim: A plan statement that the system performs a check and fixtures showing intended behavior do not establish that the check was performed in current practice.
   quote: "likewise do not establish that the check was performed in current practice."
   extractor called it about: plan statements and fixtures as evidence of current C6 enforcement

4. claim: The matrix wording can support role records as starting inputs and traceability for C6 evidence.
   quote: "can support role records as the starting inputs and traceability for C6 evidence."
   extractor called it about: matrix wording “already practiced; evidence begins with role records”

5. claim: The matrix wording does not override the requirement that manual enforcement leave a named artifact.
   quote: "It does not override the matrix’s own requirement that manual enforcement leave a named artifact."
   extractor called it about: C6 matrix manual-enforcement evidence requirement

6. claim: For the C6 row to cite actual enforcement evidence, Slice C would need to produce and retain named artifacts identifying the invocation or target, role assignments, the C6 rule evaluated, and the result.
   quote: "Slice C would need to produce and retain named artifacts that identify, at minimum, the invocation or target, relevant role/authority assignments, the C6 rule evaluated, and the result."
   extractor called it about: Slice C artifacts for C6 matrix enforcement evidence

7. claim: A named authorization decision or validator result recording the C6 evaluation could be evidence of a performed check.
   quote: "a named authorization decision or validator result recording the C6 evaluation could be evidence of a performed check."
   extractor called it about: named authorization decisions or validator results for C6

8. claim: The plan does not expressly specify a C6-result artifact.
   quote: "The plan does not expressly specify such a C6-result artifact."
   extractor called it about: planned Slice C artifacts

9. claim: The proposed one-hop check is not a general C6 check.
   quote: "the proposed one-hop check is not a general C6 check."
   extractor called it about: proposed one-hop C6 check

10. claim: The one-hop check addresses a direct adjudicator/executor collision.
   quote: "That addresses a direct adjudicator/executor collision."
   extractor called it about: proposed one-hop C6 check scope

11. claim: The supplied plan does not state that its one-hop outcome evaluates all three axes, accountable authority, or the independent-verification-edge condition.
   ...
   extractor called it about: proposed one-hop C6 check coverage
...
12. claim: After admission and actual use, the plan could potentially create partial C6 enforcement evidence only if it emits named records of C6 evaluations.
   ...
   extractor called it about: planned Slice C outputs as partial C6 enforcement evidence

13. claim: The plan’s existing proposed outputs and seed role records would not alone turn the absence of a current record naming the check into evidence that the check was performed.
   ...
   extractor called it about: existing proposed outputs and seed role records

14. claim: No additional evidence is needed to reach the distinction between a performed check and role or authorization records.
   quote: "No additional evidence is needed to reach that distinction."
   extractor called it about: distinction between C6 check evidence and role or authorization records

15. claim: To determine whether the planned schemas can represent every relevant C6 condition, the reviewer would need the unsupplied Section 4.13 material and the definition or representation of an independent verification edge.
   quote: "I would need the referenced but unsupplied Section 4.13 material on accountable authority and the definition/representation of an “independent verification edge.”"
   extractor called it about: planned schemas’ representation of C6 conditions
...
```
{"links":[{"claim":1,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":2,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":3,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":4,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":5,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":6,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":7,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":8,"block":"PLAN-20260723-0002#expected_outputs[1]"},{"claim":9,"block":"PLAN-20260723-0002#scope[12]"},{"claim":10,"block":"PLAN-20260723-0002#scope[5]"},{"claim":11,"block":"PLAN-20260723-0002#scope[5]"},{"claim":12,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":13,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":14,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":15,"block":"ABS-0004:v7:S4.9#def:a-role-composes-three-independent"}]}
```
...
{"claim":2,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m","reason_if_null":null},
...
{"claim":6,"block":"PLAN-20260723-0002#scope[3]","reason_if_null":null},
{"claim":7,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":8,"block":"PLAN-20260723-0002#expected_outputs[1]","reason_if_null":null},
...
{"claim":12,"block":"PLAN-20260723-0002#rationale[0]","reason_if_null":null},
{"claim":13,"block":"PLAN-20260723-0002#expected_outputs[5]","reason_if_null":null},
{"claim":14,"block":null,"reason_if_null":"This is the extractor's own meta-reasoning about the sufficiency of prior distinctions, not an assertion about a specific source block."},
{"claim":15,"block":"ABS-0004:v7:S4.9#def:a-role-composes-three-independent","reason_if_null":null}
]}
```
