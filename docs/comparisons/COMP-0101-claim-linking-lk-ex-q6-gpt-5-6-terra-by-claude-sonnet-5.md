# COMP-0101: Provider Comparison — Claim linking LK-EX-Q6-gpt-5-6-terra-by-claude-sonnet-5

## Metadata

- comparison_id: `COMP-0101`
- title: `Claim linking LK-EX-Q6-gpt-5-6-terra-by-claude-sonnet-5`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-28977f6b5c5e462a.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0101", "target_id": "INV-28977f6b5c5e462a"}, {"authoritative": false, "evidence": "docs/invocations/INV-b5ff1fdba245781b.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0101", "target_id": "INV-b5ff1fdba245781b"}]`
- created_at: `2026-07-29T06:35:13.700716+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q6-gpt-5-6-terra-by-claude-sonnet-5 You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: Slice C as described would not, merely by adding role and authorization records, give C6's matrix row current enforcement evidence.
   quote: "Slice C as described would not, merely by adding role and authorization records, give C6’s matrix row current enforcement evidence."
   extractor called it about: C6 matrix row enforcement evidence status

2. claim: Role records and authorization records can name assignments, scopes, issuers, executors, and perhaps the three authority-axis values; they are evidence of what was recorded or asserted.
   quote: "They are evidence of what was recorded or asserted."
   extractor called it about: role and authorization records

3. claim: Role and authorization records are not by themselves evidence that C6 was checked—that independence across epistemic, action, and accountable authority was evaluated for a particular invocation, or that the C6 exercise restriction was applied.
   quote: "not by themselves evidence that C6 was checked**—i.e., that independence across epistemic, action, and accountable authority was evaluated for a particular invocation, or that the C6 exercise restriction was applied."
   extractor called it about: role and authorization records vs C6 check evidence

4. claim: A plan statement that the system performs such a check, and fixtures showing intended behavior, likewise do not establish that the check was performed in current practice.
   quote: "A plan statement that the system performs such a check, and fixtures showing intended behavior, likewise do not establish that the check was performed in current practice."
   extractor called it about: plan statements and fixtures as evidence

5. claim: The matrix wording 'already practiced; evidence begins with role records' can support role records as the starting inputs and traceability for C6 evidence, but does not override the matrix's own requirement that manual enforcement leave a named artifact.
   quote: "It does not override the matrix’s own requirement that manual enforcement leave a named artifact."
   extractor called it about: matrix activation condition wording

6. claim: For the row to cite actual enforcement evidence, Slice C would need to produce and retain named artifacts that identify, at minimum, the invocation or target, relevant role/authority assignments, the C6 rule evaluated, and the result.
   quote: "For the row to cite actual enforcement evidence, Slice C would need to produce and retain named artifacts that identify, at minimum, the invocation or target, relevant role/authority assignments, the C6 rule evaluated, and the result."
   extractor called it about: requirements for C6 enforcement evidence artifact

7. claim: The plan does not expressly specify such a C6-result artifact.
   quote: "The plan does not expressly specify such a C6-result artifact."
   extractor called it about: plan's specification of a C6-result artifact

8. claim: The proposed one-hop check is not a general C6 check; it checks whether an 'adjudicator-authority role' is being authorized over an artifact whose direct produced_by invocation has the same executor identity, addressing only a direct adjudicator/executor collision.
   quote: "the proposed one-hop check is not a general C6 check. It checks whether an “adjudicator-authority role” is being authorized over an artifact whose direct `produced_by` invocation has the same executor identity."
   extractor called it about: Slice C one-hop check scope

9. claim: C6 also requires independent assignment across epistemic authority, action authority, and accountable authority, and prohibits specified co-exercise absent an independent verification edge.
   quote: "C6 also requires independent assignment across “epistemic authority, action authority, and accountable authority,” and prohibits specified co-exercise absent “an independent verification edge.”"
   extractor called it about: C6 rule requirements

10. claim: The supplied plan does not state that its one-hop outcome evaluates all three axes, accountable authority, or the independent-verification-edge condition.
   quote: "The supplied plan does not state that its one-hop outcome evaluates all three axes, accountable authority, or the independent-verification-edge condition."
   extractor called it about: plan's coverage of C6 axes and verification-edge condition

11. claim: The plan describes the check as 'one-hop' and 'direct-only.'
   quote: "it describes the check as “one-hop” and “direct-only.”"
   extractor called it about: plan's description of the check

12. claim: After admission and actual use, the plan could potentially create partial C6 enforcement evidence only if it emits named records of C6 evaluations.
   quote: "the plan could potentially create **partial** C6 enforcement evidence only if it emits named records of C6 evaluations."
   extractor called it about: potential for partial C6 enforcement evidence

13. claim: The existing proposed outputs and seed role records would not alone turn 'none (no current record names the check)' into evidence that the check was performed.
   quote: "Its existing proposed outputs and seed role records would not alone turn “none (no current record names the check)” into evidence that the check was performed."
   extractor called it about: sufficiency of proposed outputs and seed role records

14. claim: No additional evidence is needed to reach that distinction.
   quote: "No additional evidence is needed to reach that distinction."
   extractor called it about: sufficiency of available material for the main distinction

15. claim: To determine whether the planned schemas actually can represent every relevant C6 condition, the answer would need the referenced but unsupplied Section 4.13 material on accountable authority and the definition/representation of an 'independent verification edge.'
   quote: "To determine whether the planned schemas actually can represent every relevant C6 condition, I would need the referenced but unsupplied Section 4.13 material on accountable authority and the definition/representation of an “independent verification edge.”"
   extractor called it about: Section 4.13 material on accountable authority and independent verification edge
...
```
{"links":[{"claim":1,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":2,"block":"PLAN-20260723-0002#scope[3]"},{"claim":3,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":4,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":5,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":6,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":7,"block":null,"reason_if_null":"It concerns an omission across the plan: no expressly specified C6-result artifact."},{"claim":8,"block":"PLAN-20260723-0002#scope[5]"},{"claim":9,"block":"ABS-0004:v7:C6#whole"},{"claim":10,"block":"PLAN-20260723-0002#scope[5]"},{"claim":11,"block":"PLAN-20260723-0002#success_criteria[3]"},{"claim":12,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":13,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":14,"block":null,"reason_if_null":"It is a conclusion about the sufficiency of the available material, not a specific source passage."},{"claim":15,"block":null,"reason_if_null":"It concerns referenced but unsupplied Section 4.13 material and the missing definition of an independent verification edge."}]}
```
...
```
{"links":[
{"claim":1,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m","reason_if_null":null},
{"claim":2,"block":null,"reason_if_null":"General reasoning about what role/authorization records can contain, not quoting or asserting about one specific source block"},
{"claim":3,"block":"ABS-0004:v7:C6#whole","reason_if_null":null},
{"claim":4,"block":null,"reason_if_null":"This is the answer's own reasoning/conclusion about plan statements and fixtures generally, not a claim about one specific block's content"},
{"claim":5,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m","reason_if_null":null},
{"claim":6,"block":null,"reason_if_null":"This is the answer's own derived requirement/reasoning, not a statement drawn from a specific source block"},
{"claim":7,"block":"PLAN-20260723-0002#scope[5]","reason_if_null":null},
{"claim":8,"block":"PLAN-20260723-0002#scope[5]","reason_if_null":null},
{"claim":9,"block":"ABS-0004:v7:C6#whole","reason_if_null":null},
{"claim":10,"block":"PLAN-20260723-0002#scope[5]","reason_if_null":null},
{"claim":11,"block":"PLAN-20260723-0002#success_criteria[3]","reason_if_null":null},
{"claim":12,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m","reason_if_null":null},
{"claim":13,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m","reason_if_null":null},
{"claim":14,"block":null,"reason_if_null":"Meta-commentary about the answer's own reasoning process, not about any specific source block"},
{"claim":15,"block":null,"reason_if_null":"Refers to unsupplied Section 4.13 material, which is explicitly noted as missing from the candidate list"}
]}
```
