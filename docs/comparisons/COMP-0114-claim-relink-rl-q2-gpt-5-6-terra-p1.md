# COMP-0114: Provider Comparison — Claim relink RL-Q2-gpt-5-6-terra-p1

## Metadata

- comparison_id: `COMP-0114`
- title: `Claim relink RL-Q2-gpt-5-6-terra-p1`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-779cd2e90d25c439.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0114", "target_id": "INV-779cd2e90d25c439"}, {"authoritative": false, "evidence": "docs/invocations/INV-714fc19d45a9f7d3.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0114", "target_id": "INV-714fc19d45a9f7d3"}]`
- created_at: `2026-07-30T13:34:08.726110+00:00`
- command: `scripts/compare_providers.py --title Claim relink RL-Q2-gpt-5-6-terra-p1 You are linking claims to the block of source text each claim is about. The source document has been amended since these claims were written, and the blocks below are the amended text. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The claim that a self-issued mark disqualifies an authorization from counting as independent wherever independence is required overstates the mechanism, since Section 4.13 records self_issued:true but states no validation, decision, or admission rule requiring rejection.
...
2. claim: A scope declaration should be recorded in a form that permits its breadth to be assessed, without claiming that records or summaries ensure arbitrarily wide scope is presented as wide.
...
3. claim: The honest version should state that a scope declaration should be recorded in a form permitting its breadth to be assessed, while acknowledging the section does not itself ensure wide scopes are presented as wide.
...
4. claim: A `self_issued: true` mark does not itself require a consumer to reject a self-issued authorization when independence is required.
...
```
{"links":[{"claim":1,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona","ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"],"reason_if_empty":""},{"claim":2,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-legibility-requirement-is-unen","ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-and-bread"],"reason_if_empty":""},{"claim":3,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-legibility-requirement-is-unen","ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-and-bread"],"reason_if_empty":""},{"claim":4,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona","ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"],"reason_if_empty":""}]}
```
...
```
{"links":[
{"claim":1,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona"],"reason_if_empty":""},
{"claim":2,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-legibility-requirement-is-unen","ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-and-bread"],"reason_if_empty":""},
{"claim":3,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-legibility-requirement-is-unen","ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-and-bread"],"reason_if_empty":""},
{"claim":4,"blocks":["ABS-0004:v7:S3#adopted_constraint:the-disqualification-is-conditiona","ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"],"reason_if_empty":""}
]}
```
