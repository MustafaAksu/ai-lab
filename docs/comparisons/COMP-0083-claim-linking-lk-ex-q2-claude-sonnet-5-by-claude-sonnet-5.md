# COMP-0083: Provider Comparison — Claim linking LK-EX-Q2-claude-sonnet-5-by-claude-sonnet-5

## Metadata

- comparison_id: `COMP-0083`
- title: `Claim linking LK-EX-Q2-claude-sonnet-5-by-claude-sonnet-5`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-a86f5429dcd62ddf.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0083", "target_id": "INV-a86f5429dcd62ddf"}, {"authoritative": false, "evidence": "docs/invocations/INV-8fe08c58c0b72380.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0083", "target_id": "INV-8fe08c58c0b72380"}]`
- created_at: `2026-07-29T06:18:49.171065+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q2-claude-sonnet-5-by-claude-sonnet-5 You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The visibility claim in the standing-authority constraint overclaims completeness.
   quote: "The visibility claim in the standing-authority constraint overclaims completeness."
   extractor called it about: v7 ADOPTED_CONSTRAINT visibility sentence

2. claim: The mechanism actually described only records a claim and declares a scope; nothing establishes a mechanism that guarantees every authorization resting on it is in fact legible and attributable.
   quote: "The mechanism actually described is: a claim is *recorded*, and a scope is *declared*."
   extractor called it about: v7 ADOPTED_CONSTRAINT visibility mechanism

3. claim: The chain-termination rule's requirement that non-root authorizations must chain to a standing authority is a requirement, not an enforcement mechanism.
   quote: "a requirement is not an enforcement mechanism"
   extractor called it about: chain-termination rule

4. claim: The subordinate-inheritance rule concedes the gap directly, since undeclared subordinate execution is merely a disclosure violation under 4.7, not something the mechanism prevents or automatically surfaces.
   quote: "undeclared subordinate execution is merely "a disclosure violation under 4.7," not something the mechanism prevents or automatically surfaces"
   extractor called it about: subordinate-inheritance rule / Section 4.7

5. claim: "Every authorization resting on it" is stated as an achieved property when the described mechanism only supports the weaker claim that authorizations correctly declared and not defeated by omission are legible.
   quote: "authorizations that are correctly declared and not defeated by omission are legible"
   extractor called it about: v7 ADOPTED_CONSTRAINT visibility sentence scope of 'every authorization'

6. claim: The honest version would state that visibility applies to authorizations that are declared and correctly chained, and that undeclared or non-conforming authorizations are not made visible by this constraint but depend on separate detection under 4.7.
   quote: "What the record provides is visibility for authorizations that are declared and correctly chained: the claim, its declared scope, and the authorizations that comply with disclosure requirements are legible and attributable."
   extractor called it about: rewrite of v7 ADOPTED_CONSTRAINT visibility sentence

7. claim: Section 4.7 (disclosure-violation handling) is needed in evidence to check whether it actually closes the visibility gap; if it does, the overclaim is smaller than assessed, and if it doesn't, the overclaim stands as written.
   quote: "if it doesn't (e.g., if 4.7 is itself only a classification, not a detection mechanism), the overclaim stands as written"
   extractor called it about: Section 4.7 disclosure-violation handling

8. claim: The retraction itself overclaims a general impossibility from a single defeated instance.
   quote: "The retraction itself overclaims a general impossibility from a single defeated instance."
   extractor called it about: v7 OPEN sentence on internal control

9. claim: The evidence from COMP-0037 shows only that one specific rule was defeated by one specific maneuver, not that no possible internal control could close the regress.
   quote: "That shows one specific rule was defeated by one specific maneuver."
   extractor called it about: COMP-0037 evidentiary support for v7 OPEN sentence

10. claim: The sentence converts a demonstrated failure of one rule into a flat universal claim, stated as something v7 "records" (i.e., as settled) rather than as a hypothesis consistent with P7 but not established by the cited case.
   quote: "The sentence converts a demonstrated failure of one rule into a flat universal claim ("no internal control can close it"), stated as something v7 "records," i.e., as settled, rather than as a hypothesis consistent with P7 but not established by the cited case."
   extractor called it about: v7 OPEN sentence on internal control

11. claim: The honest version would say v7 does not assert a stronger internal control, that the one control tried (v6) was defeated by two independent reviewers using the same path, that v7 does not know of an internal control that would survive that path, and that whether some other internal control could close the regress is unresolved, with P7 treating this as expected in principle but as a stated position rather than something demonstrated by COMP-0037 alone.
   quote: "v7 does not assert a stronger internal control; the one control tried (v6) was defeated by two independent reviewers using the same path, and v7 does not know of an internal control that would survive that path."
   extractor called it about: rewrite of v7 OPEN sentence on internal control

12. claim: P6's actual text is needed to check whether v7's characterization of P6 (that pretending otherwise would be the overclaim P6 forbids) is itself accurate.
   quote: "I can't check whether this characterization of P6 is itself accurate without P6."
   extractor called it about: P6 text

13. claim: COMP-0037 itself (not just the summary sentence) is needed to check whether "two reviewers independently defeated it" supports only "this rule failed" or something closer to the broader claim v7 draws from it.
   quote: "to check whether "two reviewers independently defeated it" supports only "this rule failed" or something closer to the broader claim v7 draws from it"
   extractor called it about: COMP-0037 source material
...
```
{"links":[{"claim":1,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":2,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":3,"block":"ABS-0004:v7:S3#def:authorization-chain-termination-a"},{"claim":4,"block":"ABS-0004:v7:S3#def:subordinate-authorization-inherita"},{"claim":5,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":6,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":7,"block":null,"reason_if_null":"The claim concerns the contents and effectiveness of Section 4.7 disclosure-violation handling, which is not included in the candidate blocks."},{"claim":8,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require"},{"claim":9,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require"},{"claim":10,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require"},{"claim":11,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require"},{"claim":12,"block":null,"reason_if_null":"The claim concerns P6's actual text, which is not included in the candidate blocks."},{"claim":13,"block":null,"reason_if_null":"The claim concerns the underlying COMP-0037 source material itself, which is not included in the candidate blocks."}]}
```
...
{"claim":3,"block":"ABS-0004:v7:S3#def:authorization-chain-termination-a","reason_if_null":null},
{"claim":4,"block":"ABS-0004:v7:S3#def:subordinate-authorization-inherita","reason_if_null":null},
{"claim":5,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco","reason_if_null":null},
{"claim":6,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco","reason_if_null":null},
{"claim":7,"block":null,"reason_if_null":"Refers to Section 4.7 disclosure-violation handling content, which is not present as its own block among candidates."},
{"claim":8,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require","reason_if_null":null},
{"claim":9,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require","reason_if_null":null},
{"claim":10,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require","reason_if_null":null},
{"claim":11,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require","reason_if_null":null},
{"claim":12,"block":null,"reason_if_null":"Refers to the actual text of P6, which is not among the candidate blocks (only P7 is listed)."},
{"claim":13,"block":null,"reason_if_null":"Refers to COMP-0037 as a source document itself, not present as a block among the candidates."}
]}
```
