# COMP-0100: Provider Comparison — Claim linking LK-EX-Q6-claude-sonnet-5-by-gpt-5-6-terra

## Metadata

- comparison_id: `COMP-0100`
- title: `Claim linking LK-EX-Q6-claude-sonnet-5-by-gpt-5-6-terra`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-f46b2e0e23ca6ec9.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0100", "target_id": "INV-f46b2e0e23ca6ec9"}, {"authoritative": false, "evidence": "docs/invocations/INV-eaa6deefcfdabadb.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0100", "target_id": "INV-eaa6deefcfdabadb"}]`
- created_at: `2026-07-29T06:34:03.812996+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q6-claude-sonnet-5-by-gpt-5-6-terra You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The plan's phrasing overstates what Slice C would provide for C6.
   quote: "only partially, and the plan's phrasing overstates it."
   extractor called it about: Slice C rationale for C6 authority separation

2. claim: Slice C would satisfy C6's named precondition by producing the role records identified as where evidence begins.
   quote: "Slice C would satisfy the *precondition* named in the row"
   extractor called it about: C6 activation condition and role-record dependency

3. claim: Slice C does not produce the artifact-validator enforcement check for C6 itself.
   quote: "something that checks C6 itself, not merely records that name roles."
   extractor called it about: C6 target enforcement artifact validator

4. claim: Independent-verification-edge assessment is outside Slice C's scope until Slice D.
   quote: "independence assessment" as Slice D work"
   extractor called it about: Slice C scope and C6 independent verification edge assessment

5. claim: A RoleDefinition or InvocationAuthorization record evidences named roles and authorizations, not that the C6 axis-collision check was performed.
   quote: "it is not evidence that the axis-collision check the C6 text describes was *performed*"
   extractor called it about: RoleDefinition and InvocationAuthorization records as C6 enforcement evidence

6. claim: No component in Slice C's scope performs the C6 axis-collision check.
   quote: "no component in Slice C's scope performs that check"
   extractor called it about: Slice C C6 axis-collision enforcement

7. claim: Slice C's one-hop self-adjudication check evaluates executor identity rather than epistemic/action axis co-exercise.
   quote: "the closest analog (one-hop self-adjudication) checks executor identity, not epistemic/action axis co-exercise"
   extractor called it about: Slice C one-hop self-adjudication check

8. claim: The claim that Slice C lets the C6 row cite something is true only in the narrow sense that Slice C supplies the named role-record dependency.
   quote: "is true only in the narrow sense that it supplies the named dependency (role records)"
   extractor called it about: Plan rationale that Slice C lets C6 cite something

9. claim: Slice C does not give the C6 row a citable enforcement artifact for the C6 check itself.
   quote: "It is not true in the sense the sentence implies, that Slice C gives the row a citable *enforcement* artifact"
   extractor called it about: C6 citable enforcement artifact

10. claim: The C6 artifact-validator enforcement for the axis-exercise restriction remains unbuilt, and independent-verification-edge assessment is out of scope until a later slice.
   quote: "the target enforcement ("artifact validator") for the axis-exercise restriction remains unbuilt"
   extractor called it about: C6 target enforcement and later-slice scope

11. claim: CAP-0015, CAP-0016, and GAP-0005 are listed in the plan's evidence_ids but were not included.
   ...
   extractor called it about: CAP-0015, CAP-0016, and GAP-0005 evidence records

12. claim: ABS-0004 v7 Section 4.13 and Section 8 are absent, though they are relevant to confirming what InvocationAuthorization records attest to.
   quote: "Also absent is ABS-0004 v7 Section 4.13 (DecisionRecord fields) and Section 8 (consequence classification)"
   extractor called it about: ABS-0004 v7 Sections 4.13 and 8
...
```
{"links":[{"claim":1,"block":"PLAN-20260723-0002#rationale[0]"},{"claim":2,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":3,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":4,"block":"PLAN-20260723-0002#non_goals[2]"},{"claim":5,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":6,"block":"PLAN-20260723-0002#proposed_change"},{"claim":7,"block":"PLAN-20260723-0002#scope[5]"},{"claim":8,"block":"PLAN-20260723-0002#rationale[0]"},{"claim":9,"block":"PLAN-20260723-0002#rationale[0]"},{"claim":10,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m"},{"claim":11,"block":null,"reason_if_null":"The claim concerns the omitted CAP-0015, CAP-0016, and GAP-0005 source records collectively, which are not present as a single candidate block."},{"claim":12,"block":null,"reason_if_null":"The claim concerns absent ABS-0004 v7 Sections 4.13 and 8, neither of which is included among the candidate blocks."}]}
```
...
```
{"links":[
{"claim":1,"block":"PLAN-20260723-0002#rationale[0]","reason_if_null":null},
...
{"claim":4,"block":"PLAN-20260723-0002#non_goals[2]","reason_if_null":null},
...
{"claim":8,"block":"PLAN-20260723-0002#rationale[0]","reason_if_null":null},
{"claim":9,"block":"PLAN-20260723-0002#rationale[0]","reason_if_null":null},
{"claim":10,"block":"ABS-0004:v7:S9#def:normative-state-proposed-adopted-m","reason_if_null":null},
{"claim":11,"block":null,"reason_if_null":"Claim spans multiple separate evidence_ids entries (CAP-0015, CAP-0016, GAP-0005) collectively, not a single specific block."},
{"claim":12,"block":null,"reason_if_null":"References ABS-0004 v7 Sections 4.13 and 8 content, which are not present among the candidate blocks (only referenced indirectly in plan scope items, not the actual sections)."}
]}
```
