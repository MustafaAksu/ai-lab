# COMP-0094: Provider Comparison — Claim linking LK-EX-Q4-gpt-5-6-terra-by-gpt-5-6-terra

## Metadata

- comparison_id: `COMP-0094`
- title: `Claim linking LK-EX-Q4-gpt-5-6-terra-by-gpt-5-6-terra`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-9eb1b8b60aa9aa7b.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0094", "target_id": "INV-9eb1b8b60aa9aa7b"}, {"authoritative": false, "evidence": "docs/invocations/INV-6c85a1fe596afee4.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0094", "target_id": "INV-6c85a1fe596afee4"}]`
- created_at: `2026-07-29T06:28:22.817623+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q4-gpt-5-6-terra-by-gpt-5-6-terra You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The ten refusal reasons are not complete for the plan’s stated meaning of a valid authorization.
   quote: "The ten reasons are not complete for the plan’s stated meaning of a “valid authorization.”"
   extractor called it about: the plan's ten authorize() refusal reasons

2. claim: The plan neither incorporates, excludes, nor defers the Section 4.7 disclosure constraints.
   quote: "But it neither incorporates nor excludes or defers the Section 4.7 disclosure constraints."
   extractor called it about: Section 4.7 disclosure constraints in the plan's authorization validity meaning

3. claim: The omission of a disposition for the Section 4.7 disclosure constraints is material.
   quote: "That omission is material."
   extractor called it about: the plan's omission regarding Section 4.7 disclosure constraints

4. claim: The plan should state that authorize() checks the Section 4.7 constraints as validity conditions from stored declarations and records.
   quote: "The plan should state that the Section 4.7 constraints are **checked by `authorize()` as validity conditions**, from stored declarations and records"
   extractor called it about: authorize() handling of Section 4.7 disclosure constraints

5. claim: authorize() should refuse when a material subordinate execution capable of influencing output or external effect is not represented as an Invocation linked to its parent by spawned.
   ...
   extractor called it about: undisclosed material subordinate execution

6. claim: The existing subordinate-execution refusal reason does not cover an undisclosed subordinate execution.
   quote: "It does not cover an undisclosed subordinate at all."
   extractor called it about: existing refusal reason for subordinate execution outside declared classes

7. claim: authorize() should refuse when an execution-path-changing tool configuration is not declared and content-addressed in its EffectiveInputManifest.
   ...
   extractor called it about: undeclared execution-path-changing ToolIdentity configuration

8. claim: authorize() should refuse when material external interactions are undeclared for relevant executors.
   quote: "for executors producing governed evidence or holding above-read_only action authority, refuse where material external interactions are undeclared."
   extractor called it about: undeclared material external interaction

9. claim: The plan should identify OutboundInteractionLog as the relevant stored enforcement evidence for undeclared material external interaction.
   quote: "The plan should say that the relevant stored enforcement evidence is the `OutboundInteractionLog`;"
   extractor called it about: OutboundInteractionLog evidence for external-interaction disclosure

10. claim: authorize() remains pure by evaluating stored records rather than performing I/O.
   quote: "`authorize()` remains pure by evaluating stored records rather than performing I/O."
   extractor called it about: authorize() evaluation behavior

11. claim: If the plan excludes or defers the Section 4.7 checks, it must say so expressly and must not call the result a valid authorization under the adopted v7 meaning.
   quote: "it must say so expressly and must not describe its result as a valid authorization under the adopted v7 meaning."
   extractor called it about: plan disposition if Section 4.7 checks are excluded or deferred

12. claim: Deferral would leave the invocation experimental or require a clearly narrower Slice-C-only term.
   quote: "Deferral would leave the invocation experimental, or otherwise require a clearly narrower, Slice-C-only term"
   extractor called it about: deferral of Section 4.7 disclosure checks

13. claim: The enumerated refusal reasons lack a case for no matching authorization covering the invocation.
   quote: "But no listed refusal reason is “no authorization covers this invocation.”"
   extractor called it about: absence of authorization coverage among the ten refusal reasons

14. claim: An unmet independence requirement must refuse even when the direct one-hop artifact test does not trigger.
   ...
   extractor called it about: authorizations requiring independence

15. claim: The plan cannot silently pass an authorization requiring independence when it cannot establish independence.
   quote: "it cannot silently pass an authorization that requires independence but cannot establish it."
   extractor called it about: deferred independence assessment

16. claim: The listed reason “authorization conditions unmet, malformed, or absent” combines materially distinct failures.
   quote: "combines a substantive failed condition, malformed authorization data, and missing conditions."
   extractor called it about: listed refusal reason authorization conditions unmet, malformed, or absent

17. claim: The listed reason “authorization or a record it relies on is inactive or superseded” combines materially distinct status failures.
   quote: "combines status failure of the authorization itself with status failure of a relied-on record."
   extractor called it about: listed refusal reason for inactive or superseded authorization or relied-on record

18. claim: The listed subordinate-execution reason aggregates exceeding declared executor kind, role, and consequence ceiling while omitting undisclosed subordinate execution.
   ...
   extractor called it about: listed refusal reason for subordinate execution outside declared classes

19. claim: The supplied evidence is sufficient to identify the omissions.
   quote: "The supplied evidence is sufficient to identify these omissions."
   extractor called it about: supplied evidence

20. claim: A complete assessment of every possible validity refusal is not possible from the supplied evidence alone.
   quote: "A complete assessment of every possible validity refusal is not possible from this evidence alone:"
   extractor called it about: assessment of all possible validity refusals

21. claim: A complete assessment would need Section 4.9, Section 4.13, and the Section 11 definition of OutboundInteractionLog.
   quote: "Section 4.9 would be needed for the full RoleDefinition constraint fields, Section 4.13 for all inherited DecisionRecord requirements"
   extractor called it about: evidence needed for complete validity-refusal assessment
...
```
{"links":[{"claim":1,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":2,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":3,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":4,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":5,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":6,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":7,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":8,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":9,"block":"ABS-0004:v7:S4.6-4.7#adopted_constraint:external-interaction-disclosure-an","reason_if_null":""},{"claim":10,"block":"PLAN-20260723-0002#constraints[3]","reason_if_null":""},{"claim":11,"block":"PLAN-20260723-0002#scope[7]","reason_if_null":""},{"claim":12,"block":"PLAN-20260723-0002#scope[7]","reason_if_null":""},{"claim":13,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":14,"block":"PLAN-20260723-0002#scope[11]","reason_if_null":""},{"claim":15,"block":"PLAN-20260723-0002#non_goals[2]","reason_if_null":""},{"claim":16,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":17,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":18,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":""},{"claim":19,"block":null,"reason_if_null":"The claim is an assessment of the supplied evidence as a whole, not a specific candidate passage."},{"claim":20,"block":null,"reason_if_null":"The claim concerns the limits of an assessment based on supplied evidence, not a specific candidate block."},{"claim":21,"block":null,"reason_if_null":"The claim concerns additional source sections needed for a complete assessment, rather than one listed passage."}]}
```
...
{"claim":4,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":5,"block":"ABS-0004:v7:S4.6-4.7#adopted_constraint:composite-executor-disclosure-an-i","reason_if_null":null},
{"claim":6,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
...
{"claim":10,"block":"PLAN-20260723-0002#constraints[3]","reason_if_null":null},
{"claim":11,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":12,"block":"PLAN-20260723-0002#scope[7]","reason_if_null":null},
{"claim":13,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":14,"block":"PLAN-20260723-0002#scope[5]","reason_if_null":null},
{"claim":15,"block":"PLAN-20260723-0002#non_goals[2]","reason_if_null":null},
{"claim":16,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":17,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":18,"block":"PLAN-20260723-0002#scope[4]","reason_if_null":null},
{"claim":19,"block":null,"reason_if_null":"Meta-commentary about the sufficiency of supplied evidence for the assessment itself, not about a specific source block."},
{"claim":20,"block":null,"reason_if_null":"Meta-commentary about limits of the assessment given available evidence, not about a specific source block."},
{"claim":21,"block":null,"reason_if_null":"References ABS-0004 Sections 4.9, 4.13, and 11 (OutboundInteractionLog definition), none of which appear among the candidate blocks."}
]}
```
