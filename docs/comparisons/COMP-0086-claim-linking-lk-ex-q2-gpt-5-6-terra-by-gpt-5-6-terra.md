# COMP-0086: Provider Comparison — Claim linking LK-EX-Q2-gpt-5-6-terra-by-gpt-5-6-terra

## Metadata

- comparison_id: `COMP-0086`
- title: `Claim linking LK-EX-Q2-gpt-5-6-terra-by-gpt-5-6-terra`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-7f83bbf63da17c63.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0086", "target_id": "INV-7f83bbf63da17c63"}, {"authoritative": false, "evidence": "docs/invocations/INV-2c4a91e64f76657b.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0086", "target_id": "INV-2c4a91e64f76657b"}]`
- created_at: `2026-07-29T06:19:58.800394+00:00`
- command: `scripts/compare_providers.py --title Claim linking LK-EX-Q2-gpt-5-6-terra-by-gpt-5-6-terra You are linking extracted claims to the specific block of source text each claim is about. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The sentence claiming visibility of every authorization resting on a claim overstates what the described record fields and rules establish.
   quote: "every authorization resting on it are legible and attributable."
   extractor called it about: Section 4.13 visibility of the authorization dependency set

2. claim: The honest version is that recorded and linked authorizations can be visible and attributable only to the extent they are recorded and linked, without establishing complete visibility.
   quote: "This text does not establish completeness of that visibility."
   extractor called it about: Section 4.13 visibility of the authorization dependency set

3. claim: The sentence claiming that visibility is the whole achieved function of the constraint overstates the achieved result.
   quote: "Visibility is the whole of what this constraint achieves, and it is not prevention."
   extractor called it about: Section 4.13 visibility constraint

4. claim: The constraint should describe visibility as its intended and limited function, subject to complete and usable recording.
   quote: "It should say that visibility is the intended and limited function, subject to complete and usable recording."
   extractor called it about: Section 4.13 visibility constraint

5. claim: The sentence requiring a wide scope to be legible as wide and restricting descriptions in records or summaries is not established by the shown mechanism.
   quote: "A wide scope is permitted and must be legible as wide;"
   extractor called it about: authority_scope field and record or summary descriptions

6. claim: A scope declaration should be recorded in a form that permits its breadth to be assessed, without claiming that records or summaries ensure arbitrarily wide scope is presented as wide.
   quote: "this section does not by itself ensure that records or summaries present an arbitrarily wide scope as wide."
   extractor called it about: authority_scope field and record or summary descriptions

7. claim: A `self_issued: true` mark does not itself require a consumer to reject a self-issued authorization when independence is required.
   quote: "A mark supports disclosure; it does not itself produce disqualification."
   extractor called it about: self_issued mark and InvocationAuthorization independence requirements

8. claim: The phrase “countable as such” is ambiguous after disqualification from counting as independent authorization.
   quote: "“countable as such” is ambiguous after “disqualified from counting as independent authorization”"
   extractor called it about: self-issued authorization counting status

9. claim: A receiving rule requiring independent authorization should not count a marked self-issued authorization as independent.
   quote: "that rule should not count a marked self-issued authorization as independent;"
   extractor called it about: self-issued authorization and independence requirements

10. claim: The rationale that the accountable party necessarily authorizes work it is also responsible for is unsupported because responsibility is not the same as performing or self-authorizing work.
   quote: "Responsibility for work is not the same thing as performing or self-authorizing it."
   extractor called it about: root self-issued authorization rationale

11. claim: A root authorization may be self-issued when the accountable principal also performs the invocation, but it need not be self-issued.
   quote: "A root authorization may be self-issued when the accountable principal also performs the invocation, but root authorization need not be self-issued."
   extractor called it about: root authorization

12. claim: AI-Lab should be described as not validating entitlement through the repository records described, which cannot establish or verify root authority.
   quote: "Those records cannot establish or verify the extra-systemic fact of root authority."
   extractor called it about: AI-Lab repository-record validation

13. claim: The retraction's claim that no internal control can close the question is a universal impossibility claim not established by the supplied evidence.
   quote: "“no internal control can close it.”"
   extractor called it about: v7 retraction and internal controls

14. claim: v7 should not claim that its internal records establish root authority, and the limited purposes for which internal controls combined with external evidence can constrain authorization should remain open.
   quote: "whether, and for what limited purpose, internal controls combined with external evidence can constrain authorization remains open."
   extractor called it about: v7 retraction and internal controls

15. claim: The assertion about COMP-0037 and v6 cannot be independently assessed from the supplied evidence.
   quote: "cannot be independently assessed from the supplied evidence."
   extractor called it about: COMP-0037 and the relevant v6 rule
...
```
{"links":[{"claim":1,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":2,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":3,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":4,"block":"ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"},{"claim":5,"block":"ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-not-bound"},{"claim":6,"block":"ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-not-bound"},{"claim":7,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":8,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":9,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":10,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":11,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke"},{"claim":12,"block":"ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi"},{"claim":13,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require"},{"claim":14,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require"},{"claim":15,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require"}]}
```
...
{"claim":5,"block":"ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-not-bound","reason_if_null":null},
{"claim":6,"block":"ABS-0004:v7:S3#adopted_constraint:scope-breadth-is-visible-not-bound","reason_if_null":null},
{"claim":7,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke","reason_if_null":null},
{"claim":8,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke","reason_if_null":null},
{"claim":9,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke","reason_if_null":null},
{"claim":10,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke","reason_if_null":null},
{"claim":11,"block":"ABS-0004:v7:S3#adopted_constraint:self-issued-authorization-is-marke","reason_if_null":null},
{"claim":12,"block":"ABS-0004:v7:S3#principle:p7-root-authority-is-extra-systemi","reason_if_null":null},
...
{"claim":15,"block":"ABS-0004:v7:S3#open:whether-standing-authority-require","reason_if_null":null}
]}
```
