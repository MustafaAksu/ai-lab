# COMP-0113: Provider Comparison — Claim relink RL-Q2-claude-sonnet-5-p1

## Metadata

- comparison_id: `COMP-0113`
- title: `Claim relink RL-Q2-claude-sonnet-5-p1`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-b1a93accd5a2926e.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0113", "target_id": "INV-b1a93accd5a2926e"}, {"authoritative": false, "evidence": "docs/invocations/INV-0dae7e735fd96a73.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0113", "target_id": "INV-0dae7e735fd96a73"}]`
- created_at: `2026-07-30T13:33:45.367691+00:00`
- command: `scripts/compare_providers.py --title Claim relink RL-Q2-claude-sonnet-5-p1 You are linking claims to the block of source text each claim is about. The source document has been amended since these claims were written, and the blocks below are the amended text. This is a matching task. Do not evaluate whether any claim is correct.
...
1. claim: The described mechanism only supports visibility for authorizations that are correctly declared and not defeated by omission.
...
```
{"links":[{"claim":1,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco---","ABS-0004:v7:S3#adopted_constraint:a-disclosure-violation-under-4-7-i ---"],"reason_if_empty":""}]}
```
...
```
{"links":[{"claim":1,"blocks":["ABS-0004:v7:S3#adopted_constraint:a-standing-authority-claim-is-reco"],"reason_if_empty":""}]}
```
