# COMP-0043: Provider Comparison — Slice C admission Q4 refusal-completeness

## Metadata

- comparison_id: `COMP-0043`
- title: `Slice C admission Q4 refusal-completeness`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-3e7bc88549b7f5ac.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0043", "target_id": "INV-3e7bc88549b7f5ac"}, {"authoritative": false, "evidence": "docs/invocations/INV-bc052fff304f7e80.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0043", "target_id": "INV-bc052fff304f7e80"}]`
- created_at: `2026-07-28T18:50:28.986893+00:00`
- command: `scripts/compare_providers.py --title Slice C admission Q4 refusal-completeness You are reviewing a proposed ontology amendment and the implementation plan that depends on it. This is ONE question of eight, each asked in a separate call with its own evidence set. Do not attempt to answer the others.
