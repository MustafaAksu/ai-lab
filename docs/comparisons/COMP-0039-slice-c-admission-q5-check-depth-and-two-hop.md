# COMP-0039: Provider Comparison — Slice C admission Q5 check-depth-and-two-hop

## Metadata

- comparison_id: `COMP-0039`
- title: `Slice C admission Q5 check-depth-and-two-hop`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-bd98440b1d15fd36.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0039", "target_id": "INV-bd98440b1d15fd36"}, {"authoritative": false, "evidence": "docs/invocations/INV-534bb2275b5b2728.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0039", "target_id": "INV-534bb2275b5b2728"}]`
- created_at: `2026-07-28T18:35:16.922859+00:00`
- command: `scripts/compare_providers.py --title Slice C admission Q5 check-depth-and-two-hop You are reviewing a proposed ontology amendment and the implementation plan that depends on it. This is ONE question of eight, each asked in a separate call with its own evidence set. Do not attempt to answer the others.
...
=== EVIDENCE ABS-0004:v7:C3 :: ABS-0004 v7 constraint C3 (no self-adjudication, executor-generic) ===
