# COMP-0044: Provider Comparison — Slice C admission Q6 does-slice-evidence-c6

## Metadata

- comparison_id: `COMP-0044`
- title: `Slice C admission Q6 does-slice-evidence-c6`
- invocation_produced_by: `[{"authoritative": false, "evidence": "docs/invocations/INV-84f23fa7b98a9895.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0044", "target_id": "INV-84f23fa7b98a9895"}, {"authoritative": false, "evidence": "docs/invocations/INV-a7fc235164c665fc.json", "predicate": "produced_by", "relation_source": "future_edge_seed", "scope": "invocation_provenance_slice_a", "source_id": "COMP-0044", "target_id": "INV-a7fc235164c665fc"}]`
- created_at: `2026-07-28T18:51:28.960749+00:00`
- command: `scripts/compare_providers.py --title Slice C admission Q6 does-slice-evidence-c6 You are reviewing a proposed ontology amendment and the implementation plan that depends on it. This is ONE question of eight, each asked in a separate call with its own evidence set. Do not attempt to answer the others.
...
=== EVIDENCE ABS-0004:v7:S9 :: ABS-0004 v7 Section 9 (enforcement matrix) ===
...
=== EVIDENCE ABS-0004:v7:C6 :: ABS-0004 v7 constraint C6 (authority separation) ===
